...
{ 
    public class CapConsumerRegister : IConsumerRegister
    {
        ...
        public CapConsumerRegister(ILogger<CapConsumerRegister> logger, IServiceProvider serviceProvider)
        {
            _logger = logger;
        ...
        private void RegisterMessageProcessor(IConsumerClient client)
        {
            ...
            {
                _logger.MessageReceived(transportMessage.GetId(), transportMessage.GetName() + " " + transportMessage.GetGroup());
                ...
                try
                {
                    ...
                    {
                        if (!transportMessage.Headers.TryGetValue(Headers.Exception, out string _))
